            ...
            <View key={post.id} style={styles.tweetContainer}>
              ...
              <View style={styles.tweetRight}>
                <View style={styles.tweetHeaderRow}>
                  ...
                  {post.farmer_id === currentUserId ? (
                    <TouchableOpacity onPress={() => handlePostOptions(post)} style={styles.optionsBtn}>
                      <Ionicons name="ellipsis-vertical" size={16} color={colors.textSecondary} />
                    </TouchableOpacity>
                  ) : (
                    <TouchableOpacity 
                      style={[styles.followBtn, post.is_following && styles.followingBtn]} 
                      onPress={() => handleFollowToggle(post.farmer_id, post.is_following)}
                    >
